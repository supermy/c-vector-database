...
| 依赖库 | rust-ds20code | rust-glm5 | rust-kimi25 | rust-minimax25 | rust-qwen35 |
|--------|:-------------:|:---------:|:-----------:|:--------------:|:-----------:|
| **rayon** (并行) | ✅ | ✅ | ✅ | ✅ | ✅ |
| **parking_lot** (锁) | ✅ | ✅ | ✅ | ✅ | ✅ |
| **dashmap** (并发Map) | ✅ | ✅ | ✅ | ✅ | ✅ |
...
| 索引类型 | rust-ds20code | rust-glm5 | rust-kimi25 | rust-minimax25 | rust-qwen35 |
|----------|:-------------:|:---------:|:-----------:|:--------------:|:-----------:|
| **Flat (暴力搜索)** | ✅ | ✅ | ✅ | ✅ | ✅ |
| **HNSW (近似搜索)** | ✅ | ❌ | ✅ | ❌ | ❌ |
| **IVF (倒排索引)** | ❌ | ❌ | ❌ | ✅ | ❌ |
...
| 优化技术 | rust-ds20code | rust-glm5 | rust-kimi25 | rust-minimax25 | rust-qwen35 |
|----------|:-------------:|:---------:|:-----------:|:--------------:|:-----------:|
| **循环展开** | ✅ (8路) | ✅ (8路) | ✅ (16路) | ❌ | ❌ |
| **unsafe指针优化** | ✅ | ❌ | ❌ | ❌ | ❌ |
| **f64精度计算** | ✅ | ✅ | ✅ | ❌ | ❌ |
...
| 特性 | rust-ds20code | rust-glm5 | rust-kimi25 | rust-minimax25 | rust-qwen35 |
|------|:-------------:|:---------:|:-----------:|:--------------:|:-----------:|
| **并行搜索** | ✅ rayon | ✅ rayon | ✅ rayon | ✅ rayon | ✅ rayon |
| **并行批量搜索** | ✅ | ✅ | ✅ | ✅ | ✅ |
| **细粒度锁** | ✅ RwLock | ✅ RwLock | ✅ RwLock | ✅ DashMap | ✅ RwLock |
| **Arc共享** | ✅ (HNSW) | ❌ | ❌ | ✅ | ✅ |

### 编译优化对比

| 优化选项 | rust-ds20code | rust-glm5 | rust-kimi25 | rust-minimax25 | rust-qwen35 |
|----------|:-------------:|:---------:|:-----------:|:--------------:|:-----------:|
| **opt-level** | 3 | 3 | 3 | 3 | 3 |
| **LTO** | fat | true | true | true | true |
| **codegen-units** | 1 | 1 | 1 | 1 | 1 |
| **target-cpu** | native | native | native | native | native |
| **panic** | - | - | abort | - | abort |
